function [averagedEMG, accumulatedEMG] = downSampleAveragedEMG(filteredEMG, processedGait)
    ...
    accumulatedEMG.left = struct('HAM', [], 'RF', [], 'MG', [], 'TA', [], 'VL', []);
    accumulatedEMG.right = struct('HAM', [], 'RF', [], 'MG', [], 'TA', [], 'VL', []);
    ...
    averagedEMG.left = struct('HAM', [], 'RF', [], 'MG', [], 'TA', [], 'VL', []);
    averagedEMG.right = struct('HAM', [], 'RF', [], 'MG', [], 'TA', [], 'VL', []);
