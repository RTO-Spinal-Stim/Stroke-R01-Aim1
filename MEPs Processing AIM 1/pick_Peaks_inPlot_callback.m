...
%% PURPOSE: ALLOW THE USER TO MANUALLY SELECT TEPs PEAKS.

% SRC is 2 different buttons: continue or skip (since nothing was seen)

if strcmp(src.String, 'Continue') | strcmp(src.String, 'Continue')
...
elseif strcmp(src.String, 'Skip') | strcmp(src.String, 'Skip')
...
fig.UserData.FoundLat = foundLat;
fig.UserData.MaxIdxPicked = maxIDX_picked;
fig.UserData.MinIdxPicked = minIDX_picked;
fig.UserData.StimIdxPicked = sitmIDX_picked;
...
% assignin('base', 'sitmIDX_picked', sitmIDX_picked);
